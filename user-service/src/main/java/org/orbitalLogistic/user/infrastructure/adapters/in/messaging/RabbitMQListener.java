package org.orbitalLogistic.user.infrastructure.adapters.in.messaging;
...
/**
 * RabbitMQ message listener for user-service.
...
public class RabbitMQListener {
    ...
    /**
     * Listens to messages from the user-service queue.
