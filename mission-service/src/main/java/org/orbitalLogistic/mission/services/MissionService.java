...
public class MissionService {
    ...
    public MissionResponseDTO createMission(MissionRequestDTO request) {
        // Проверка существования mission code
        ...
        // Валидация commanding officer через Feign Client
        try {
            ...
            throw new InvalidOperationException("Unable to validate commanding officer. User service may be unavailable.");
        }

        // Валидация spacecraft через Feign Client
        try {
