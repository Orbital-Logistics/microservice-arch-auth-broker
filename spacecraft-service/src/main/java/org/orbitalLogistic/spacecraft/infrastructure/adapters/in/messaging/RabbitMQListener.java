package org.orbitalLogistic.spacecraft.infrastructure.adapters.in.messaging;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.orbitalLogistic.spacecraft.config.RabbitMQConfig;
import org.springframework.amqp.rabbit.annotation.RabbitListener;
import org.springframework.stereotype.Component;

/**
 * RabbitMQ message listener for spacecraft-service.
...
public class RabbitMQListener {
    ...
    /**
     * Listens to messages from the spacecraft-service queue.
    ...
    public void handleMessage(Object message) {
        log.info("Received message in spacecraft-service: {}", message);
