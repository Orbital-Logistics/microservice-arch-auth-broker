...
class SpacecraftTypeServiceTest {
    ...
    void createSpacecraftType_Success() {
        ...
        SpacecraftTypeResponseDTO result = spacecraftTypeService.createSpacecraftType(spacecraftTypeRequest);
    ...
    void createSpacecraftType_SaveFailed() {
        ...
        assertThrows(SpacecraftTypeNotFoundException.class,
                () -> spacecraftTypeService.createSpacecraftType(spacecraftTypeRequest));
    ...
    void getEntityById_Success() {
        ...
        SpacecraftType result = spacecraftTypeService.getEntityById(1L);
    ...
    void getEntityById_NotFound() {
        ...
        assertThrows(SpacecraftTypeNotFoundException.class,
                () -> spacecraftTypeService.getEntityById(999L));
