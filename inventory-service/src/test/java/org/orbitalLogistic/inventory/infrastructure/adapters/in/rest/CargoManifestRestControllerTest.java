...
class CargoManifestRestControllerTest {
    ...
    void getAllManifests_Success() {
        ...
        CargoManifestResponseDTO responseDTO = new CargoManifestResponseDTO(
                ...
                org.orbitalLogistic.inventory.infrastructure.adapters.in.rest.dto.ManifestStatus.PENDING,
                org.orbitalLogistic.inventory.infrastructure.adapters.in.rest.dto.ManifestPriority.NORMAL
        );
    ...
    void updateManifest_Success() {
        CargoManifestRequestDTO requestDTO = new CargoManifestRequestDTO(
                1L, 1L, 1L, 10, LocalDateTime.now(), null, 1L, null,
                org.orbitalLogistic.inventory.infrastructure.adapters.in.rest.dto.ManifestStatus.LOADED,
                org.orbitalLogistic.inventory.infrastructure.adapters.in.rest.dto.ManifestPriority.HIGH
        );
