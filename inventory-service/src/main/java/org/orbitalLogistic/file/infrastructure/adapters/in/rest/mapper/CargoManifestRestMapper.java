...
public class CargoManifestRestMapper {
    ...
    private org.orbitalLogistic.file.domain.model.enums.ManifestStatus mapManifestStatus(
            org.orbitalLogistic.file.infrastructure.adapters.in.rest.dto.ManifestStatus dto) {
        if (dto == null) return null;
        return org.orbitalLogistic.file.domain.model.enums.ManifestStatus.valueOf(dto.name());
    }

    private org.orbitalLogistic.file.infrastructure.adapters.in.rest.dto.ManifestStatus mapManifestStatusToRest(
            org.orbitalLogistic.file.domain.model.enums.ManifestStatus domain) {
        if (domain == null) return null;
        return org.orbitalLogistic.file.infrastructure.adapters.in.rest.dto.ManifestStatus.valueOf(domain.name());
    }

    private org.orbitalLogistic.file.domain.model.enums.ManifestPriority mapManifestPriority(
            org.orbitalLogistic.file.infrastructure.adapters.in.rest.dto.ManifestPriority dto) {
        if (dto == null) return null;
        return org.orbitalLogistic.file.domain.model.enums.ManifestPriority.valueOf(dto.name());
    }

    private org.orbitalLogistic.file.infrastructure.adapters.in.rest.dto.ManifestPriority mapManifestPriorityToRest(
            org.orbitalLogistic.file.domain.model.enums.ManifestPriority domain) {
        if (domain == null) return null;
        return org.orbitalLogistic.file.infrastructure.adapters.in.rest.dto.ManifestPriority.valueOf(domain.name());
    }
}
