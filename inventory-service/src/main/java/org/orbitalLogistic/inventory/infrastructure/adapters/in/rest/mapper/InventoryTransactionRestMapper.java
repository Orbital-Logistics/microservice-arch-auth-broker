...
public class InventoryTransactionRestMapper {
    ...
    private org.orbitalLogistic.inventory.domain.model.enums.TransactionType mapTransactionType(
            org.orbitalLogistic.inventory.infrastructure.adapters.in.rest.dto.TransactionType dto) {
        if (dto == null) return null;
        return org.orbitalLogistic.inventory.domain.model.enums.TransactionType.valueOf(dto.name());
    }

    private org.orbitalLogistic.inventory.infrastructure.adapters.in.rest.dto.TransactionType mapTransactionTypeToRest(
            org.orbitalLogistic.inventory.domain.model.enums.TransactionType domain) {
        if (domain == null) return null;
        return org.orbitalLogistic.inventory.infrastructure.adapters.in.rest.dto.TransactionType.valueOf(domain.name());
    }
}
